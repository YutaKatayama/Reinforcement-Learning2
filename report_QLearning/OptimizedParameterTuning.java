...
public class OptimizedParameterTuning {
                    ...
                    for (double gamma = gammaStart; gamma <= gammaEnd; gamma += gammaStep) {
                        ...
                        executor.submit(() -> {
                            ...
                            try {
                                ...
                                // 結果をOptimizedParameterTuning.csvに出力
                                try (PrintWriter writer = new PrintWriter(
                                        new OutputStreamWriter(
                                            new FileOutputStream("OptimizedParameterTuning.csv", true),
                                            StandardCharsets.UTF_8
                                        ))) {

                                    if (!new File("OptimizedParameterTuning.csv").exists()) {
                                        writer.write('\ufeff');
                                    }
